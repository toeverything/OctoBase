...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Blobs::Timestamp).timestamp_with_time_zone().not_null())
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager.drop_index(Index::drop().name("blobs_list").to_owned()).await?;
