...
fn operations(c: &mut Criterion) {
    ...
    group.bench_function("jwst array insert", |b| {
    ...
    group.bench_function("yrs array insert", |b| {
        let base_text = "test1 test2 test3 test4 test5 test6 test7 test8 test9";
        let mut rng = rand_chacha::ChaCha20Rng::seed_from_u64(1234);
    ...
    group.bench_function("jwst array insert range", |b| {
        let base_text = "test1 test2 test3 test4 test5 test6 test7 test8 test9";
        let mut rng = rand_chacha::ChaCha20Rng::seed_from_u64(1234);
    ...
    group.bench_function("yrs array insert range", |b| {
        let base_text = "test1 test2 test3 test4 test5 test6 test7 test8 test9";
        let mut rng = rand_chacha::ChaCha20Rng::seed_from_u64(1234);
