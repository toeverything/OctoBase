...
pub trait DocStorage<E = JwstError> {
    ...
    async fn flush_workspace(&self, workspace_id: String, data: Vec<u8>) -> JwstResult<Workspace, E>;
    /// delete a workspace
    ...
    async fn update_doc(&self, workspace_id: String, guid: String, data: &[u8]) -> JwstResult<(), E>;
